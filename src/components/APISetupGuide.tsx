      ...
      <div className="bg-gray-800 border border-gray-700 rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
            <h4 className="text-green-400 font-medium mb-2">✅ Map Services Ready</h4>
            <p className="text-gray-300 text-sm">
              Using OpenStreetMap for location services - no additional API key required!
            </p>
          </div>
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
            ...
            <ul className="text-gray-300 text-sm space-y-1">
              ...
              <li>• OpenStreetMap provides free location services</li>
              <li>• The app will work with sample data if OpenAI isn't configured</li>
            </ul>
          </div>

          <div className="flex justify-end">
            <AnimatedButton onClick={onClose} animation="glow">Got it!</AnimatedButton>
          </div>
        </div>
      </div>
    </div>
